...
originbase='/mnt/hadoop/store/group/bruxljm/FWLJMET102X_1lep2017_Oct2019_4t_03092021_step2/'
destbase='/mnt/hadoop/store/group/bruxljm/FWLJMET102X_1lep2017_Oct2019_4t_03092021_step2p5/'
...
for f in files:
	...
	newtree = tree.CopyTree("(NJetsCSV_JetSubCalc >= 2)")
	newtree.Write()
