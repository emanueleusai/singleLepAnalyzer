...
systematicList = ['pileup','prefire','btag','mistag','jec','jer','PSwgt','muRF','pdf']#'hotstat','hotcspur','hotclosure',#,'njet','hdamp','ue','ht','trigeff','toppt','tau32','jmst','jmrt','tau21','jmsW','jmrW','tau21pt']
doAllSys = True
doQ2sys  = False
