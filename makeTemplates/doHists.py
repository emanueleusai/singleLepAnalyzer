...
plotList = {#discriminantName:(discriminantLJMETName, binning, xAxisLabel)
	...
	'NPV'   :('nPV_MultiLepCalc',linspace(0, 60, (61-1)*nbin_multiplier+1).tolist(),';PV multiplicity'),
	'nTrueInt':('nTrueInteractions_MultiLepCalc',linspace(0, 75, (76-1)*nbin_multiplier+1).tolist(),';# true interactions'),
	'lepPt' :('leptonPt_MultiLepCalc',linspace(0, 600, (121-1)*nbin_multiplier+1).tolist(),';Lepton p_{T} [GeV]'),
	'lepEta':('leptonEta_MultiLepCalc',linspace(-4, 4, (41-1)*nbin_multiplier+1).tolist(),';Lepton #eta'),
	'JetEta':('theJetEta_JetSubCalc_PtOrdered',linspace(-4, 4, (41-1)*nbin_multiplier+1).tolist(),';AK4 jet #eta'),
	'JetPt' :('theJetPt_JetSubCalc_PtOrdered',linspace(0, 1500, (51-1)*nbin_multiplier+1).tolist(),';jet p_{T} [GeV]'),
	'Jet1Pt':('theJetPt_JetSubCalc_PtOrdered[0]',linspace(0, 1500, (51-1)*nbin_multiplier+1).tolist(),';p_{T}(j_{1}) [GeV]'),
	'Jet2Pt':('theJetPt_JetSubCalc_PtOrdered[1]',linspace(0, 1500, (51-1)*nbin_multiplier+1).tolist(),';p_{T}(j_{2}) [GeV]'),
	'Jet3Pt':('theJetPt_JetSubCalc_PtOrdered[2]',linspace(0, 800, (51-1)*nbin_multiplier+1).tolist(),';p_{T}(j_{3}) [GeV]'),
	'Jet4Pt':('theJetPt_JetSubCalc_PtOrdered[3]',linspace(0, 500, (51-1)*nbin_multiplier+1).tolist(),';p_{T}(j_{4}) [GeV]'),
	'Jet5Pt':('theJetPt_JetSubCalc_PtOrdered[4]',linspace(0, 500, (51-1)*nbin_multiplier+1).tolist(),';p_{T}(j_{5}) [GeV]'),
	'Jet6Pt':('theJetPt_JetSubCalc_PtOrdered[5]',linspace(0, 500, (51-1)*nbin_multiplier+1).tolist(),';p_{T}(j_{6}) [GeV]'),
	'JetPtBins' :('theJetPt_JetSubCalc_PtOrdered',linspace(0,2000,(21-1)*nbin_multiplier+1).tolist(),';AK4 jet p_{T} [GeV]'),
	'Jet1PtBins':('theJetPt_JetSubCalc_PtOrdered[0]',linspace(0,2000,(21-1)*nbin_multiplier+1).tolist(),';p_{T}(j_{1}) [GeV]'),
	'Jet2PtBins':('theJetPt_JetSubCalc_PtOrdered[1]',linspace(0,2000,(21-1)*nbin_multiplier+1).tolist(),';p_{T}(j_{2}) [GeV]'),
	'Jet3PtBins':('theJetPt_JetSubCalc_PtOrdered[2]',linspace(0,2000,(21-1)*nbin_multiplier+1).tolist(),';p_{T}(j_{3}) [GeV]'),
	'Jet4PtBins':('theJetPt_JetSubCalc_PtOrdered[3]',linspace(0,2000,(21-1)*nbin_multiplier+1).tolist(),';p_{T}(j_{4}) [GeV]'),
	'Jet5PtBins':('theJetPt_JetSubCalc_PtOrdered[4]',linspace(0,2000,(21-1)*nbin_multiplier+1).tolist(),';p_{T}(j_{5}) [GeV]'),
	'Jet6PtBins':('theJetPt_JetSubCalc_PtOrdered[5]',linspace(0,2000,(21-1)*nbin_multiplier+1).tolist(),';p_{T}(j_{6}) [GeV]'),
	#'MET'   :('corr_met_MultiLepCalc',linspace(0, 1000, (51-1)*nbin_multiplier+1).tolist(),';#slash{E}_{T} [GeV]'),
	'MET'   :('corr_met_MultiLepCalc',linspace(0, 1000, (51-1)*nbin_multiplier+1).tolist(),';p_{T}^{miss} [GeV]'),
	'NJets' :('NJets_JetSubCalc',linspace(0, 15, (16-1)*nbin_multiplier+1).tolist(),';AK4 jet multiplicity'),
	'NBJets':('NJetsCSVwithSF_JetSubCalc',linspace(0, 10, (11-1)*nbin_multiplier+1).tolist(),';b-tagged jet multiplicity'),
	'NBJetsNoSF':('NJetsCSV_JetSubCalc',linspace(0, 10, (11-1)*nbin_multiplier+1).tolist(),';b-tagged jet multiplicity'),
	'NDCSVBJets':('NJetsCSVwithSF_MultiLepCalc',linspace(0, 10, (11-1)*nbin_multiplier+1).tolist(),';b-tagged jet multiplicity'),
	'NDCSVBJetsNoSF':('NJetsCSV_MultiLepCalc',linspace(0, 10, (11-1)*nbin_multiplier+1).tolist(),';b-tagged jet multiplicity'),
	'NWJets':('NJetsWtagged',linspace(0, 6, (7-1)*nbin_multiplier+1).tolist(),';W-tagged jet multiplicity'),
	'NTJets':('NJetsTtagged',linspace(0, 4, (5-1)*nbin_multiplier+1).tolist(),';t-tagged jet multiplicity'),
	'NJetsAK8':('NJetsAK8_JetSubCalc',linspace(0, 8, (9-1)*nbin_multiplier+1).tolist(),';AK8 jet multiplicity'),
	'JetPtAK8':('theJetAK8Pt_JetSubCalc_PtOrdered',linspace(0, 1500, (51-1)*nbin_multiplier+1).tolist(),';AK8 jet p_{T} [GeV]'),
	'JetPtBinsAK8':('theJetAK8Pt_JetSubCalc_PtOrdered',bigbins,';AK8 jet p_{T} [GeV];'),
	'JetEtaAK8':('theJetAK8Eta_JetSubCalc_PtOrdered',linspace(-4, 4, (41-1)*nbin_multiplier+1).tolist(),';AK8 jet #eta'),
	'Tau21'  :('theJetAK8NjettinessTau2_JetSubCalc_PtOrdered/theJetAK8NjettinessTau1_JetSubCalc_PtOrdered',linspace(0, 1, (51-1)*nbin_multiplier+1).tolist(),';AK8 jet #tau_{2}/#tau_{1}'),
	'Tau21Nm1'  :('theJetAK8NjettinessTau2_JetSubCalc_PtOrdered/theJetAK8NjettinessTau1_JetSubCalc_PtOrdered',linspace(0, 1, (51-1)*nbin_multiplier+1).tolist(),';AK8 jet #tau_{2}/#tau_{1}'),
	'Tau32'  :('theJetAK8NjettinessTau3_JetSubCalc_PtOrdered/theJetAK8NjettinessTau2_JetSubCalc_PtOrdered',linspace(0, 1, (51-1)*nbin_multiplier+1).tolist(),';AK8 jet #tau_{3}/#tau_{2}'),
	'Tau32Nm1'  :('theJetAK8NjettinessTau3_JetSubCalc_PtOrdered/theJetAK8NjettinessTau2_JetSubCalc_PtOrdered',linspace(0, 1, (51-1)*nbin_multiplier+1).tolist(),';AK8 jet #tau_{3}/#tau_{2}'),
	'Pruned' :('theJetAK8PrunedMass_JetSubCalc_PtOrdered',linspace(0, 500, (51-1)*nbin_multiplier+1).tolist(),';AK8 jet pruned mass [GeV]'),
	'PrunedSmeared' :('theJetAK8PrunedMass_JetSubCalc_PtOrdered',linspace(0, 500, (51-1)*nbin_multiplier+1).tolist(),';AK8 jet pruned mass [GeV]'),
	'PrunedSmearedNm1' :('theJetAK8PrunedMassWtagUncerts_JetSubCalc_PtOrdered',linspace(0, 500, (51-1)*nbin_multiplier+1).tolist(),';AK8 jet pruned mass [GeV]'),
	'SoftDropMass' :('theJetAK8SoftDropCorr_JetSubCalc_PtOrdered',linspace(0, 500, (51-1)*nbin_multiplier+1).tolist(),';AK8 jet soft-drop mass [GeV]'),
	'SoftDropMassNm1W' :('theJetAK8SoftDropCorr_JetSubCalc_PtOrdered',linspace(0, 500, (51-1)*nbin_multiplier+1).tolist(),';AK8 jet soft-drop mass [GeV]'),
	'SoftDropMassNm1t' :('theJetAK8SoftDropCorr_JetSubCalc_PtOrdered',linspace(0, 500, (51-1)*nbin_multiplier+1).tolist(),';AK8 jet soft-drop mass [GeV]'),
	'mindeltaR':('minDR_lepJet',linspace(0, 4, (51-1)*nbin_multiplier+1).tolist(),';#DeltaR(l, closest jet)'),
	'deltaRjet1':('deltaR_lepJets[0]',linspace(0, 5, (51-1)*nbin_multiplier+1).tolist(),';#DeltaR(l,j_{1})'),
	'deltaRjet2':('deltaR_lepJets[1]',linspace(0, 5, (51-1)*nbin_multiplier+1).tolist(),';#DeltaR(l,j_{2})'),
	'deltaRjet3':('deltaR_lepJets[2]',linspace(0, 5, (51-1)*nbin_multiplier+1).tolist(),';#DeltaR(l,j_{3})'),
	'nLepGen':('NLeptonDecays_TpTpCalc',linspace(0,10,(11-1)*nbin_multiplier+1).tolist(),';N lepton decays from TT'),
	'METphi':('corr_met_phi_MultiLepCalc',linspace(-3.2,3.2,(65-1)*nbin_multiplier+1).tolist(),';#phi(#slash{E}_{T})'),
	'lepPhi':('leptonPhi_MultiLepCalc',linspace(-3.2,3.2,(65-1)*nbin_multiplier+1).tolist(),';#phi(l)'),
	'lepDxy':('leptonDxy_MultiLepCalc',linspace(-0.02,0.02,(51-1)*nbin_multiplier+1).tolist(),';lepton xy impact param [cm]'),
	'lepDz':('leptonDz_MultiLepCalc',linspace(-0.1,0.1,(51-1)*nbin_multiplier+1).tolist(),';lepton z impact param [cm]'),
	'lepCharge':('leptonCharge_MultiLepCalc',linspace(-2,2,(5-1)*nbin_multiplier+1).tolist(),';lepton charge'),
	'lepIso':('leptonMiniIso_MultiLepCalc',linspace(0,0.1,(51-1)*nbin_multiplier+1).tolist(),';lepton mini isolation'),
	'Tau1':('theJetAK8NjettinessTau1_JetSubCalc_PtOrdered',linspace(0,1,(51-1)*nbin_multiplier+1).tolist(),';AK8 Jet #tau_{1}'),
	'Tau2':('theJetAK8NjettinessTau2_JetSubCalc_PtOrdered',linspace(0,1,(51-1)*nbin_multiplier+1).tolist(),';AK8 Jet #tau_{2}'),
	'Tau3':('theJetAK8NjettinessTau3_JetSubCalc_PtOrdered',linspace(0,1,(51-1)*nbin_multiplier+1).tolist(),';AK8 Jet #tau_{3}'),
	'JetPhi':('theJetPhi_JetSubCalc_PtOrdered',linspace(-3.2,3.2,(65-1)*nbin_multiplier+1).tolist(),';AK4 Jet #phi'),
	'JetPhiAK8':('theJetAK8Phi_JetSubCalc_PtOrdered',linspace(-3.2,3.2,(65-1)*nbin_multiplier+1).tolist(),';AK8 Jet #phi'),
	'Bjet1Pt':('BJetLeadPt',linspace(0,1500,(51-1)*nbin_multiplier+1).tolist(),';p_{T}(b_{1}) [GeV]'),  ## B TAG
	'Wjet1Pt':('WJetLeadPt',linspace(0,1500,(51-1)*nbin_multiplier+1).tolist(),';p_{T}(W_{1}) [GeV]'),
	'Tjet1Pt':('TJetLeadPt',linspace(0,1500,(51-1)*nbin_multiplier+1).tolist(),';p_{T}(t_{1}) [GeV]'),
	'topMass':('recLeptonicTopMass',linspace(0,1500,(51-1)*nbin_multiplier+1).tolist(),';M^{rec}(t) [GeV]'),
	'topPt':('recLeptonicTopPt',linspace(0,1500,(51-1)*nbin_multiplier+1).tolist(),';p_{T}^{rec}(t) [GeV]'),
	'minMlj':('minMleppJet',linspace(0,1000,(51-1)*nbin_multiplier+1).tolist(),';min[M(l,j)] [GeV], j #neq b'),
	'minMljDR':('deltaRlepJetInMinMljet',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#DeltaR(l,j) with min[M(l,j)], j #neq b'),
	'minMljDPhi':('deltaPhilepJetInMinMljet',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#Delta#phi(l,jet) with min[M(l,j)], j #neq b'),
	'minMlbDR':('deltaRlepbJetInMinMlb',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#DeltaR(l,b) with min[M(l,b)]'), ## B TAG
	'minMlbDPhi':('deltaPhilepbJetInMinMlb',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#Delta#phi(l,b) with min[M(l,b)]'), ## B TAG
	'nonMinMlbDR':('deltaRlepbJetNotInMinMlb',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#DeltaR(l,b), b #neq b in min[M(l,b)]'),  ## B TAG
	'MWb1':('M_taggedW_bjet1',linspace(0,1000,(51-1)*nbin_multiplier+1).tolist(),';M(W_{jet},b_{1}) [GeV]'), ## B TAG
	'MWb2':('M_taggedW_bjet2',linspace(0,1000,(51-1)*nbin_multiplier+1).tolist(),';M(W_{jet},b_{2}) [GeV]'), ## 2 B TAG
	'deltaRlb1':('deltaRlepbJet1',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#DeltaR(l,b_{1})'), ## B TAG
	'deltaRlb2':('deltaRlepbJet2',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#DeltaR(l,b_{2})'), ## 2 B TAG
	'deltaRtW':('deltaRtopWjet',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#DeltaR(reco t, W jet)'),
	'deltaRlW':('deltaRlepWjet',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#DeltaR(l,W_{jet})'),
	'deltaRWb1':('deltaRtaggedWbJet1',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#DeltaR(W_{jet},b_{1})'), ## B TAG
	'deltaRWb2':('deltaRtaggedWbJet2',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#DeltaR(W_{jet},b_{2})'), ## 2 B TAG
	'deltaPhilb1':('deltaPhilepbJet1',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#Delta#phi(l,b_{1})'), ## B TAG
	'deltaPhilb2':('deltaPhilepbJet2',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#Delta#phi(l,b_{2})'), ## 2 B TAG
	'deltaPhitW':('deltaPhitopWjet',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#Delta#phi(t_{lep}, W_{jet})'),
	'deltaPhilW':('deltaPhilepWjet',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#Delta#phi(l, W_{jet})'),
	'deltaPhiWb1':('deltaPhitaggedWbJet1',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#Delta#phi(W_{jet},b_{1})'), ## B TAG
	'deltaPhiWb2':('deltaPhitaggedWbJet2',linspace(0,5,(51-1)*nbin_multiplier+1).tolist(),';#Delta#phi(W_{jet},b_{2})'), ## 2 B TAG
	'WjetPt':('WJetTaggedPt',linspace(0,1500,(51-1)*nbin_multiplier+1).tolist(),';p_{T}(W_{jet}) [GeV]'),
	'PtRel':('ptRel_lepJet',linspace(0,500,(51-1)*nbin_multiplier+1).tolist(),';p_{T,rel}(l, closest jet) [GeV]'),
	'deltaPhiLMET':('deltaPhi_lepMET',linspace(-3.2,3.2,(51-1)*nbin_multiplier+1).tolist(),';#Delta#phi(l,#slash{E}_{T})'),
	'NHOTtJets':('topNtops_HOTTaggerCalc',linspace(0, 5, (6-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet multiplicity'),
	'NresolvedTops1pNoSF':('NresolvedTops1pFakeNoSF',linspace(0, 5, (6-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet multiplicity (1% fake)'),
	'NresolvedTops2pNoSF':('NresolvedTops2pFakeNoSF',linspace(0, 5, (6-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet multiplicity (2% fake)'),
	'NresolvedTops5pNoSF':('NresolvedTops5pFakeNoSF',linspace(0, 5, (6-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet multiplicity (5% fake)'),
	'NresolvedTops10pNoSF':('NresolvedTops10pFakeNoSF',linspace(0, 5, (6-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet multiplicity (10% fake)'),
	'NresolvedTops1p':('NresolvedTops1pFake',linspace(0, 5, (6-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet multiplicity (1% fake)'),
	'NresolvedTops2p':('NresolvedTops2pFake',linspace(0, 5, (6-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet multiplicity (2% fake)'),
	'NresolvedTops5p':('NresolvedTops5pFake',linspace(0, 5, (6-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet multiplicity (5% fake)'),
	'NresolvedTops10p':('NresolvedTops10pFake',linspace(0, 5, (6-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet multiplicity (10% fake)'),
	'HOTtPt':('topPt_HOTTaggerCalc',linspace(0, 1000, (51-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet p_{T} [GeV]'),
	'HOTtEta':('topEta_HOTTaggerCalc',linspace(-4, 4, (41-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet #eta'),
	'HOTtPhi':('topPhi_HOTTaggerCalc',linspace(-3.2,3.2,(65-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet #phi'),
	'HOTtMass':('topMass_HOTTaggerCalc',linspace(0, 500, (51-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet mass [GeV]'),
	'HOTtDisc':('topDiscriminator_HOTTaggerCalc',linspace(0,1,(51-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet discriminator'),
	'HOTtNconst':('topNconstituents_HOTTaggerCalc',linspace(0, 10, (11-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet # constituents'),
	'HOTtNAK4':('topNAK4_HOTTaggerCalc',linspace(0, 15, (16-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet # AK4 jets'),
	'HOTtDRmax':('topDRmax_HOTTaggerCalc',linspace(0,1,(51-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet DRmax'),
	'HOTtDThetaMax':('topDThetaMax_HOTTaggerCalc',linspace(0,1,(51-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet DThetaMax'),
	'HOTtDThetaMin':('topDThetaMin_HOTTaggerCalc',linspace(0,1,(51-1)*nbin_multiplier+1).tolist(),';resolved t-tagged jet DThetaMin'),
	'isHTgt500Njetge9':('isHTgt500Njetge9',linspace(0,2,(3-1)*nbin_multiplier+1).tolist(),';isHTgt500Njetge9'),
	'NJets_vs_NBJets':('NJets_JetSubCalc:NJetsCSV_JetSubCalc',linspace(0, 15, (16-1)*nbin_multiplier+1).tolist(),';AK4 jet multiplicity',linspace(0, 10, (11-1)*nbin_multiplier+1).tolist(),';b-tagged jet multiplicity'),
	'HT_vs_HTb':('AK4HT:HT_bjets',linspace(0, 3000, (121-1)*nbin_multiplier+1).tolist(),';H_{T} [GeV]',linspace(0, 3000, (121-1)*nbin_multiplier+1).tolist(),';H_{T}^{b} [GeV]'),
	'HT_vs_maxJJJpt':('AK4HT:maxJJJpt',linspace(0, 3000, (121-1)*nbin_multiplier+1).tolist(),';H_{T} [GeV]',linspace(0, 1500, (101-1)*nbin_multiplier+1).tolist(),';max[p_{T}^{jjj}] [GeV]'),
	'HTb_vs_maxJJJpt':('HT_bjets:maxJJJpt',linspace(0, 3000, (121-1)*nbin_multiplier+1).tolist(),';H_{T}^{b} [GeV]',linspace(0, 1500, (101-1)*nbin_multiplier+1).tolist(),';max[p_{T}^{jjj}] [GeV]'),

	'maxJJJpt':('maxJJJpt',linspace(0, 1500, (101-1)*nbin_multiplier+1).tolist(),';max[p_{T}^{jjj}] [GeV]'),
	'HTb':('HT_bjets',linspace(0, 3000, (121-1)*nbin_multiplier+1).tolist(),';H_{T}^{b} [GeV]'),
	'HT':('AK4HT',linspace(0, 3000, (121-1)*nbin_multiplier+1).tolist(),';H_{T} [GeV]'),
	'ST':('AK4HTpMETpLepPt',linspace(0, 4000, (161-1)*nbin_multiplier+1).tolist(),';S_{T} [GeV]'),
	'minMlb':('minMleppBjet',linspace(0, 1000, (101-1)*nbin_multiplier+1).tolist(),';min[M(l,b)] [GeV]'),
	'minMlbSBins':('minMleppBjet',linspace(0, 1000, (1001-1)*nbin_multiplier+1).tolist(),';min[M(l,b)] [GeV]'),
	'BDT':('BDT',linspace(-1, 1, (201-1)*nbin_multiplier+1).tolist(),';BDT'),
